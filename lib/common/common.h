...
typedef volatile int8		vs8;  /*  8 bits */
typedef volatile int16	vs16; /* 16 bits */
typedef volatile int32	vs32; /* 32 bits */

typedef volatile uint8	vuint8;  /*  8 bits */
typedef volatile uint16	vuint16; /* 16 bits */
typedef volatile uint32	vuint32; /* 32 bits */

typedef volatile uint8	vu8;  /*  8 bits */
typedef volatile uint16	vu16; /* 16 bits */
typedef volatile uint32	vu32; /* 32 bits */
