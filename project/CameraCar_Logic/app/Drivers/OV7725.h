...
#define CAMERA_BUF			 600					//摄像头传回数据大小（CAMERA_W*CAMERA_H/8）

void OV7725_Config(void);		//摄像头初始化


/*********************************************************** 
函数名称：OV7725_ImageExtract
函数功能：将获取的原始数据转换为图像
入口参数：*dst - 转换完成后存入的数组地址,数组定长4800
出口参数：无
***********************************************************/
void OV7725_ImageExtract(void *dst);

/*********************************************************** 
函数名称：OV7725_SendImage
函数功能：将转换后的图像发送至串口
入口参数：*imgaddr - 数组地址
出口参数：无
***********************************************************/
...
/*********************************************************** 
函数名称：OV7725_RefreshRate
函数功能：设置摄像头采样频率
入口参数：rate - 设置频率(1:150Hz, 2:112Hz, 3:75Hz, 4:50Hz)
出口参数：无
***********************************************************/
void OV7725_RefreshRate(u8 rate);

/*********************************************************** 
函数名称：OV7725_ChangeISO
函数功能：设置摄像头曝光值(根据场地调节)
入口参数：val - 设置阈值(0-255)
出口参数：无
***********************************************************/
...
/*********************************************************** 
函数名称：OV7725_GetReadyBuf
函数功能：读取最近一次采集完成的帧
入口参数：无
出口参数：缓冲区标志 (0-3)
***********************************************************/
u8 OV7725_GetReadyBuf(void);
